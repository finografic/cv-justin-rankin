...
const workExperience: WorkEntry[] = [
  ...
  },
  {
    ...
    technologies: ['JavaScript', 'Node.js', 'RESTful APIs', 'Docker', 'CI/CD', 'SASS / CSS'],
  },
  {
    ...
    technologies: ['JavaScript', 'Angular', 'Node.js', 'MongoDB', 'MySQL', 'RESTful APIs', 'PHP', 'AWS'],
  },
  {
  ...
  },
  {
    ...
    technologies: ['JavaScript', 'PHP', 'WordPress', 'MySQL', 'SASS / CSS', 'Linux administration'],
  },
];
